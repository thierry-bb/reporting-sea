...
export default function ImpressionsTrendChart({ data, hasLinkedIn }) {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={formatted} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
        ...
        <Legend wrapperStyle={{ fontSize: 12, color: CHART_COLORS.axis, paddingTop: 8 }} />
        <Line
          type="monotone"
          dataKey="google_impressions"
          name="Google"
